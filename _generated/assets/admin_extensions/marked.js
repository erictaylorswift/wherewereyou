...
$('head').append('<link rel="stylesheet" type="text/css" href="/assets/vendor/simplemde/dist/simplemde.min.css">')
	.append(`
	<style>
...
enduro_admin_app.compileProvider.directive('marked', function() {
	return {
